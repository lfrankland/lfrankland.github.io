...
const Splash = () => (	
	<div className={styles.splash}>
		<Container>
		<h1 className={styles.title}>Hey, I'm Louis&hellip;</h1>		
		<h2 className={styles.subTitle}>&hellip;a User Experience Designer and Frontend Developer based in Leeds</h2>
