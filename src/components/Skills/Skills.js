	...
	<div className={styles.skills}>
		...
		<ul className={styles.list}>
			<li className={styles.skill}>
				<h3>Ideation</h3>
				<p>Without ideas you don't get very far. I'm skilled in working with stakeholders to build and iterate concepts that get products user's can actually use.</p>
			</li>
			<li className={styles.skill}>
				<h3>Prototyping</h3>
			...
			<li className={styles.skill}>
				...
				<p>Working with others, be that other designers, developers, stakeholders and end users, to get results which were never thought possible.</p>
			</li>
			<li className={styles.skill}>
